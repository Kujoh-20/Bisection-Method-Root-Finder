...
<div class="header">
  ...
  <p class="meta">Generated: {now} &nbsp;|&nbsp; Version: v2.0</p>
...
def show_about():
    ...
    sub_lbl = tk.Label(hdr,
        text="Numerical Analysis  ·  Bisection & False Position  ·  v2.1",
        bg=T["primary"], fg=T["panel"],
...
root = ttkb.Window(themename=T["ttk"],
                   title="[]  Bisection Root Finder — Bisection & False Position",
                   size=(1440, 880))
