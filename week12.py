...
def build_txt_report(d):
    ...
    lines.append(f"  Version   : v3.0  (Week 12 — Testing & QA)")
...
<div class="header">
  ...
  <p class="meta">Generated: {now} &nbsp;|&nbsp; Version: v3.0 (Week 12 — Testing &amp; QA)</p>
...
def show_about():
    ...
    sub_lbl = tk.Label(hdr,
        text="Numerical Analysis  ·  Bisection & False Position  ·  v3.0 (Week 12)",
        bg=T["primary"], fg=T["panel"],
